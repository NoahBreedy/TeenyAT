;--------------------------------------------------
; Simple demonstration of the use of timers.  The program
; sets up an interreupt handler for TimerA & TimerB. TimerA draws
; a pixel to the screen every second and TimerB draws a pixel every
; half a second.
;
...
;
; Timer A will go off once every second and Timer B will go off every half a second
    set rA, 65535
    str [ TIMER_A_CMP ], rA
    str [ TIMER_B_CMP ], rA

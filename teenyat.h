...
/**
 * @brief
 *   Initialize a 1MHz clocked TeenyAT instance and buffer the file for future resets.
 *
 * @param t
...
/**
 * @brief
 *   Helper function for setting the initial pace count of a clocked instance of the TeenyAT
 * 
 * 
 * @param t

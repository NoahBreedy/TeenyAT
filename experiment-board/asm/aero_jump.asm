...
;
; Depending on machine speed... THE 'INITIAL_SPEED' 
; constant might have to be altered. This is used
; as a delay in the game loop. This is also used to 
; speed up demo for gameplay enhancement. 
;
; - John Pertell
;   11.08.24
...
.const INITIAL_SPEED 500 ; this might need to be altered, depending on machine specs
.const MAX_SPEED 100     ; the game should not go past this threshold
...
; Main delay loop => skips TeenyAT clockcycles
